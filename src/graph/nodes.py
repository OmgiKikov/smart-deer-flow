...
async def _execute_agent_step(
    ...
    if agent_name == "researcher" and state.get("resources"):
        ...
        agent_state["citation_reminder"] = (
            "ВАЖНО: НЕ включайте цитаты непосредственно в текст. Вместо этого отслеживайте все источники и добавьте в конце раздел «Список литературы» в формате ссылок. Для лучшей читаемости оставляйте пустую строку между каждой цитатой. Используйте следующий формат для каждой ссылки:\n- [Название источника](URL)\n\n- [Другой источник](URL)"
        )
